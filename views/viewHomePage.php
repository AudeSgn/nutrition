...
<head>
    ...
    <link rel="stylesheet" href="./views/homePageView.css" />
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="width: 100vw;">
                ...
                <div class="modal-bodyImc">
                    ...
                    <p id="descriptionImcModal"> L'IMC est le sigle pour Indice de Masse Corporelle. L'IMC permet de calculer la corpulence d'un individu selon sa taille et son poids. L'IMC est utilisé pour détecter les problèmes d'obésité ou de sous-poids. </p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer border border-0">
                    <button type="button" class="btnModalMealForm" data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#modalAlertCalories">Valider</button>
